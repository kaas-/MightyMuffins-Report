...
This process has its benefits since it simplifies the signal by separating the important parts such as frequency which then can be boosted and neglect unwanted properties.       
