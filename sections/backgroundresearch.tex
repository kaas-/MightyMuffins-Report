...
By grey scaling an image and committing these values to a spectrogram, they can be further analysed in a Fourier transformation which will be expanded upon in the next subsection.  
