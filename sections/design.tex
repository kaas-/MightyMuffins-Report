...
Results, as can be seen on table \ref{tab:electritest}, showed the participants preferred using the slider when changing the volume of the music. A new design was created based on this result.
...
\section{Final design sketch}\label{sec:finalsketch}
...
\caption{\label{fig:finaldesignsketch3grey} The figure shows a sketch of the final interface design with a metal frame.}
\end{figure}  
