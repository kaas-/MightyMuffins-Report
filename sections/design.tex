...
\todo{talk about what is the prefrence of different interfaces for the user}
...
However, since this is a tool for creative inspiration, it is also important to give the user the possible to modify the product 

to what they are trying to make. 
As for a painter, he would maybe change the picture, where a musician would play around with the sounds that are produced. 