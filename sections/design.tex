...
\caption{\label{fig:Earlysketchforkellige} This figure shows the first ideas regarding the artefact the  group wanted to use for the product. Three basic ideas was sketched.}
\end{figure}
